...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> St Patrik</h2></br>
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#lab-details" id="list-lab-list" role="tab" data-toggle="list" aria-controls="home">Lab</a>
                ...
                <div class="col-sm-4" style="left: 10%;margin-top:5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;">Lab</h2>
                    
                      <p class="cl-effect-1">
                        <a href="#lab-details" onclick="clickDiv('#list-lab-list')">
                          View Lab Details
                        </a>
                      </p>
                    </div>
...
<div class="tab-pane fade" id="lab-details" role="tabpanel" aria-labelledby="list-lab-list">
