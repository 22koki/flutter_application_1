...
<head>
	<title>HMS</title>
	<link rel="shortcut icon" type="image/x-icon" href="images/default-user.png" />
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp St Patrick &apos; Orthope</h4></a>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
             ...
             <input type="checkbox" id="paid" name="payment_status" value="Paid">
        
             <label for="not_paid">Not Paid:</label>
             <input type="checkbox" id="not_paid" name="payment_status" value="Not Paid">
