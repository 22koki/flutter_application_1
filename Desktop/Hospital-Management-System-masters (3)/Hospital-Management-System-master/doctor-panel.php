...
if(isset($_GET['cancel']))
  ...
  if(isset($_GET['prescribe'])){
    ...
    $xray = $_GET['xray'];  
    $query=mysqli_query($con,"insert into prestb(doctor,pid,ID,appdate,apptime,disease,allergy,prescription,medical_history,xray) values ('$doctor',$pid,$ID,'$appdate','$apptime','$disease','$allergy','$prescription','$medical_history','$xray');");
    if($query)
    {
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Patrick &apos; Orthope </a>
...
.text-primary {
  ...
  <div class="col-md-4" style="max-width:18%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-lab" id="list-lab-list" role="tab" data-toggle="list" aria-controls="home"> Lab</a>
      <a class="list-group-item list-group-item-action" href="#list-pres" id="list-pres-list" role="tab" data-toggle="list" aria-controls="home"> Prescription List</a>
      <a class="list-group-item list-group-item-action" href="#list-medhist" id="list-medhist-list" role="tab" data-toggle="list" aria-controls="home"> Medical History </a>
  ...
  <i class="fa fa-user-md fa-stack-1x fa-inverse"></i>
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;"> Medical History</h4>
                        
                      <p class="links cl-effect-1">
                        <a href="#list-medhist" onclick="clickDiv('#list-medhist-list')">
                          Medical History
                        </a>
                      </p>
                    </div>
                ...
                <div class="col-sm-4" style="left: 15%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;"> Lab </h4>
                        
                      <p class="links cl-effect-1">
                        <a href="#list-pres" onclick="clickDiv('#list-lab-list')">
                          Lab Details
                        </a>
                      </p>
                    </div>
...
<!-- Medical History -->
<div class="tab-pane fade" id="list-medhist" role="tabpanel" aria-labelledby="list-medhist-list">
  ...
  <table class="table table-hover">
    ...
    <tbody>
      <?php
        ...
        $query = "SELECT ID, pid, appdate, apptime, disease, allergy, prescription, medical_history, xray FROM prestb WHERE doctor='$doctor';";
        $result = mysqli_query($con, $query);
        if (!$result) {
          echo mysqli_error($con);
        }
...
<div class="tab-pane fade" id="add-medhist" role="tabpanel" aria-labelledby="add-medhist-list">
  <!-- Adding Medical History -->
  <div class="col-md-8">
    <form class="form-group" method="post" action="func1.php" enctype="multipart/form-data">
      <label for="patient_id">Patient ID</label>
      <input type="text" name="patient_id" class="form-control" required><br>
      <label for="disease">Disease</label>
      <input type="text" name="disease" class="form-control" required><br>
      <label for="symptoms">Symptoms</label>
      <textarea name="symptoms" class="form-control" rows="4" required></textarea><br>
      <label for="diagnosis">Diagnosis</label>
      <textarea name="diagnosis" class="form-control" rows="4" required></textarea><br>
      <label for="treatment">Treatment</label>
      <textarea name="treatment" class="form-control" rows="4" required></textarea><br>
      <label for="prescription">Prescription</label>
      <textarea name="prescription" class="form-control" rows="4" required></textarea><br>
      <label for="uploadFile">Upload Medical Records</label>
      <input type="file" name="uploadFile" class="form-control"><br>
      <input type="submit" name="submit" value="Submit" class="btn btn-primary">
    </form>
  </div>
</div>
<form method="POST" action="upload_patient_details.php" enctype="multipart/form-data">
    <label for="lab_results">Lab Results:</label>
    <textarea id="lab_results" name="lab_results"></textarea>
    
    <label for="xray_results">X-ray Results:</label>
    <textarea id="xray_results" name="xray_results"></textarea>
    ...
    <input type="file" id="xray_image" name="xray_image">
