...
class _EditPatientScreenState extends State<EditPatientScreen> {
  ...
  void initState() {
    ...
    patientIndex = Get.arguments ?? 0;

    if (patientController.patients.isEmpty ||
        patientIndex < 0 ||
        patientIndex >= patientController.patients.length) {
      patientFound = false;
      return;
    }

    final patient = patientController.patients[patientIndex];

    patientId = patient.id;
    nameController.text = patient.name;
    ageController.text = patient.age.toString();
    phoneController.text = patient.phone;
    illnessController.text = patient.illness;
